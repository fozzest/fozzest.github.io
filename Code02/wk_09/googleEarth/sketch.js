...
function newLocation(newLat,newLng){
	...
	console.log(newLocation.newLat);
}


function on(){
	var r = floor(random(0,7));
	//map.setCenter({lat: -34, lng: 151});
//attempting to call random location from my JSON
	//map.setCenter(sceneData.features[1].geometry.coordinates[0], sceneData.features[1].geometry.coordinates[1]);
	newLocation(sceneData.features[0].geometry.coordinates[0], sceneData.features[0].geometry.coordinates[1]);
	console.log(newLocation.newLat);
}
